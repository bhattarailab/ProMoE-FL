...
class EncoderResNet(nn.Module):
    def __init__(self, embed_dim, cnn_type, proj_dim = 128):
        ...
        self.proj = nn.Sequential(
                    nn.Linear(embed_dim, embed_dim), # Maintain dim first
                    nn.ReLU(),
                    nn.Linear(embed_dim, proj_dim) # Then compress
                )
    ...
    def forward(self, images):
        ...
        output['embedding'] = l2_normalize(projection)
        output['features'] = out
